                ...
                <div class="bg-white shadow-md rounded my-6 p-6">
                    ...
                    <form action="{{ route('params.impact.update', ['id' => $impact->id_impact]) }}" method="POST">
                        ...
                        <div class="flex items-center ps-2 mt-2">
                            <input id="bordered-checkbox-1" type="checkbox" value="1" {{ ($impact->masquer==1)?'checked':'' }} name="masquer" class="w-4 h-4 text-blue-600 bg-gray-100 rounded focus:ring-blue-500 focus:ring-2">
