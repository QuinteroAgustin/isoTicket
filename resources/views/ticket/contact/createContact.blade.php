        ...
        <div class="min-w-screen flex items-center justify-center font-sans overflow-hidden">
            <div class="w-full lg:w-9/10">
                <div class="bg-white shadow-md rounded my-6 p-6">
                    ...
                    <h2 class="text-lg font-bold mb-4">Création de contact pour la societe {{ $ticket->id_client }}</h2>
                    <form action="{{ route('ticket.create.contact.post', ['id' => $ticket->id_ticket]) }}" method="POST">
                        @csrf
                        <div class="mb-4">
                        ...
                        <div>
                            ...
                            <a href="{{ route('ticket.edit', ['id' => $ticket->id_ticket]) }}" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">Retour</a>
                        </div>
                    </form>
                </div>
            </div>
