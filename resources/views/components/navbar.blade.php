    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            ...
            <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600" id="user-dropdown">
                <div class="px-4 py-3">
                    <span class="block text-sm text-gray-900 dark:text-white">{{ app\Models\Technicien::findorfail(app\Models\Technicien::getTechId())->nom }} {{ app\Models\Technicien::findorfail(app\Models\Technicien::getTechId())->prenom }}</span>
                    <span class="block text-sm  text-gray-500 truncate dark:text-gray-400">{{ app\Models\Technicien::findorfail(app\Models\Technicien::getTechId())->email }}</span>
                </div>
