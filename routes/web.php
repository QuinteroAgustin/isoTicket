...
Route::get('/params/status', [ParamsController::class, 'showStatusForm'])->name('params.form.status')->middleware([Authenticate::class, 'CheckRole:1']);
Route::post('/params/status/ajouter', [ParamsController::class, 'addStatus'])->name('params.status.add')->middleware([Authenticate::class, 'CheckRole:1']);
Route::get('/params/status/modifier/{id}', [ParamsController::class, 'modifierStatus'])->name('params.status.modifier')->middleware([Authenticate::class, 'CheckRole:1']);
Route::post('/params/status/modifier/{id}', [ParamsController::class, 'updateStatus'])->name('params.status.update')->middleware([Authenticate::class, 'CheckRole:1']);
Route::delete('/params/status/supprimer/{id}', [ParamsController::class, 'supprimerStatus'])->name('params.status.supprimer')->middleware([Authenticate::class, 'CheckRole:1']);

// Route pour afficher le formulaire d'ajout de priorite
Route::get('/params/priorite', [ParamsController::class, 'showPrioriteForm'])->name('params.form.priorite')->middleware([Authenticate::class, 'CheckRole:1']);
Route::post('/params/priorite/ajouter', [ParamsController::class, 'addPriorite'])->name('params.priorite.add')->middleware([Authenticate::class, 'CheckRole:1']);
Route::get('/params/priorite/modifier/{id}', [ParamsController::class, 'modifierPriorite'])->name('params.priorite.modifier')->middleware([Authenticate::class, 'CheckRole:1']);
Route::post('/params/priorite/modifier/{id}', [ParamsController::class, 'updatePriorite'])->name('params.priorite.update')->middleware([Authenticate::class, 'CheckRole:1']);
Route::delete('/params/priorite/supprimer/{id}', [ParamsController::class, 'supprimerPriorite'])->name('params.priorite.supprimer')->middleware([Authenticate::class, 'CheckRole:1']);

// Route pour afficher le formulaire d'ajout d'impact
Route::get('/params/impact', [ParamsController::class, 'showImpactForm'])->name('params.form.impact')->middleware([Authenticate::class, 'CheckRole:1']);
Route::post('/params/impact/ajouter', [ParamsController::class, 'addImpact'])->name('params.impact.add')->middleware([Authenticate::class, 'CheckRole:1']);
Route::get('/params/impact/modifier/{id}', [ParamsController::class, 'modifierImpact'])->name('params.impact.modifier')->middleware([Authenticate::class, 'CheckRole:1']);
Route::post('/params/impact/modifier/{id}', [ParamsController::class, 'updateImpact'])->name('params.impact.update')->middleware([Authenticate::class, 'CheckRole:1']);
Route::delete('/params/impact/supprimer/{id}', [ParamsController::class, 'supprimerImpact'])->name('params.impact.supprimer')->middleware([Authenticate::class, 'CheckRole:1']);

// Route pour afficher le formulaire d'ajout de fonction
Route::get('/params/fonction', [ParamsController::class, 'showFonctionForm'])->name('params.form.fonction')->middleware([Authenticate::class, 'CheckRole:1']);
Route::post('/params/fonction/ajouter', [ParamsController::class, 'addFonction'])->name('params.fonction.add')->middleware([Authenticate::class, 'CheckRole:1']);
Route::get('/params/fonction/modifier/{id}', [ParamsController::class, 'modifierFonction'])->name('params.fonction.modifier')->middleware([Authenticate::class, 'CheckRole:1']);
Route::post('/params/fonction/modifier/{id}', [ParamsController::class, 'updateFonction'])->name('params.fonction.update')->middleware([Authenticate::class, 'CheckRole:1']);
Route::delete('/params/fonction/supprimer/{id}', [ParamsController::class, 'supprimerFonction'])->name('params.fonction.supprimer')->middleware([Authenticate::class, 'CheckRole:1']);

// Route pour afficher le formulaire d'ajout de service
Route::get('/params/service', [ParamsController::class, 'showServiceForm'])->name('params.form.service')->middleware([Authenticate::class, 'CheckRole:1']);
Route::post('/params/service/ajouter', [ParamsController::class, 'addService'])->name('params.service.add')->middleware([Authenticate::class, 'CheckRole:1']);
Route::get('/params/service/modifier/{id}', [ParamsController::class, 'modifierService'])->name('params.service.modifier')->middleware([Authenticate::class, 'CheckRole:1']);
Route::post('/params/service/modifier/{id}', [ParamsController::class, 'updateService'])->name('params.service.update')->middleware([Authenticate::class, 'CheckRole:1']);
Route::delete('/params/service/supprimer/{id}', [ParamsController::class, 'supprimerService'])->name('params.service.supprimer')->middleware([Authenticate::class, 'CheckRole:1']);

// Route pour afficher le formulaire d'ajout de categorie
Route::get('/params/categorie', [ParamsController::class, 'showCategorieForm'])->name('params.form.categorie')->middleware([Authenticate::class, 'CheckRole:1']);
Route::post('/params/categorie/ajouter', [ParamsController::class, 'addCategorie'])->name('params.categorie.add')->middleware([Authenticate::class, 'CheckRole:1']);
Route::get('/params/categorie/modifier/{id}', [ParamsController::class, 'modifierCategorie'])->name('params.categorie.modifier')->middleware([Authenticate::class, 'CheckRole:1']);
Route::post('/params/categorie/modifier/{id}', [ParamsController::class, 'updateCategorie'])->name('params.categorie.update')->middleware([Authenticate::class, 'CheckRole:1']);
Route::delete('/params/categorie/supprimer/{id}', [ParamsController::class, 'supprimerCategorie'])->name('params.categorie.supprimer')->middleware([Authenticate::class, 'CheckRole:1']);

// Route pour afficher le formulaire d'ajout de risque
Route::get('/params/risque', [ParamsController::class, 'showRisqueForm'])->name('params.form.risque')->middleware([Authenticate::class, 'CheckRole:1']);
Route::post('/params/risque/ajouter', [ParamsController::class, 'addRisque'])->name('params.risque.add')->middleware([Authenticate::class, 'CheckRole:1']);
Route::get('/params/risque/modifier/{id}', [ParamsController::class, 'modifierRisque'])->name('params.risque.modifier')->middleware([Authenticate::class, 'CheckRole:1']);
Route::post('/params/risque/modifier/{id}', [ParamsController::class, 'updateRisque'])->name('params.risque.update')->middleware([Authenticate::class, 'CheckRole:1']);
Route::delete('/params/risque/supprimer/{id}', [ParamsController::class, 'supprimerRisque'])->name('params.risque.supprimer')->middleware([Authenticate::class, 'CheckRole:1']);
